...
/**
 * checks if this card and another card share the same suit
 */
...
/**
 * checks if this card and another card share the same colour
 */
...
/**
 * checks if this card and another card share the same value
 */
...
/**
 * image name and location as a string
 */
...
UI.prototype.sounds = function(i){
  var newGameSound = new Audio('sounds/sadTrombone.mp3');
  var gameWonSound = new Audio('sounds/crowdCheer.mp3');
  var helpMenuSound = new Audio('sounds/cardFlip.mp3');
 ...
 * The help dialog
 */
UI.prototype.Instructions = function() {
  var this_ui = this;
    $('#helptext').dialog({
        title: 'Help',
        modal: true,
...
UI.prototype.welcomeScreen = function() {
...
UI.prototype.WelcomPlayButton = function() {
  var this_ui = this;
    $('#dialogStart').dialog({
        title: 'Welcome!',
        modal: true,
